...
```text
X-Internal-Key: <LTI_INTERNAL_SYNC_KEY>
...
# Shared only between Rails and this bridge, under the same name in both. It enables the OnTrack LMS tab.
LTI_INTERNAL_SYNC_KEY: your-random-internal-sync-key
